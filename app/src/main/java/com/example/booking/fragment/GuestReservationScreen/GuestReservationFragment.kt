...
import com.example.booking.adapter.ReservationAdapater
...
class GuestReservationFragment : Fragment() {
    ...
    private lateinit var adapter: ReservationAdapater
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        adapter = ReservationAdapater(requireContext(), emptyList())
